				...
				<div class="special-products all-poroducts">
					...
					<div class="special-products-grids">
						<div class="col-md-3 special-products-grid text-center">
							...
							<a class="product-here" href="single-page.jsp"><img src="image/womenshoe1.gif" title="product-name" /></a>
						...
						<div class="col-md-3 special-products-grid text-center">
							...
							<a class="product-here" href="single-page.jsp"><img src="image/womenshoe2.gif" title="product-name" /></a>
							<h4><a href="single-page.jsp">Line Link 67009</a></h4>
							<a class="product-btn" href="single-page.jsp"><span>RS2999</span><small>GET NOW</small><label> </label></a>
						</div>
						<div class="col-md-3 special-products-grid text-center">
							<a class="brand-name" href="single-page.jsp"><img src="images/b3.jpg" title="name" /></a>
							<a class="product-here" href="single-page.jsp"><img src="image/womenshoe3.gif" title="product-name" /></a>
							<h4><a href="single-page.jsp">Minimus Zero </a></h4>
							<a class="product-btn" href="single-page.jsp"><span>RS2999</span><small>GET NOW</small><label> </label></a>
						</div>
						<div class="col-md-3 special-products-grid text-center">
							<a class="brand-name" href="single-page.jsp"><img src="images/b4.jpg" title="name" /></a>
							<a class="product-here" href="single-page.jsp"><img src="image/nikeshoe4.gif" height="200px" title="product-name" /></a>
							<h4><a href="single-page.jsp"> Athletic Shoe </a></h4>
							<a class="product-btn" href="single-page.jsp"><span>RS2999</span><small>GET NOW</small><label> </label></a>
						</div>
						<div class="col-md-3 special-products-grid text-center">
							<a class="brand-name" href="single-page.jsp"><img src="images/b5.jpg" title="name" /></a>
							<a class="product-here" href="single-page.jsp"><img src="image/pumashoe1.gif" height="160px" title="product-name" /></a>
						...
						<div class="col-md-3 special-products-grid text-center">
							<a class="brand-name" href="single-page.jsp"><img src="images/b1.jpg" title="name" /></a>
							<a class="product-here" href="single-page.jsp"><img src="image/nikeshoe3.gif" height="160px" title="product-name" /></a>
