  ...
  <tr>
    ...
    <td><%out.println(c2); %>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td><br>
     <td><%out.println(d2); %>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td><br>
		    	 ...
		    	 <form action="Complaint_App" method="post" name="fr1" onsubmit="return validate()">
		    	 <div>Enter Complaint Id To be Approved<br><input type="text" value="" name="uid"></div>
		   			  &nbsp;&nbsp;<button class="grey">Approve</button>
		   			 </form>
		   			 	   <br><br>
